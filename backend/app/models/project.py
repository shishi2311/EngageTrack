...
class Project(db.Model):
    ...
    milestones = db.relationship("Milestone", back_populates="project", lazy="dynamic", order_by="Milestone.sort_order")
    status_updates = db.relationship("StatusUpdate", back_populates="project", lazy="dynamic")
